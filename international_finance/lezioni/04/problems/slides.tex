...
\begin{itemize}
\item
  la domanda di beni nazionali aumenta per
...
\item
  i prezzi iniziano a salire in modo da riportare \(P\times L\) al
  valore precedente
\item
...
\item
  ...
  interesse
\item
  la ripresa dell'economia non può passare attraverso un aumento degli
  investimenti
\end{itemize}
\end{frame}
